...
/* $C0 */ "CPY\0","CMP\0","...\0","...\0","CPY\0","CMP\0","DEC\0","...\0","INY\0","CMP\0","DEX\0","...\0","CPY\0","CMP\0","DEC\0","...\0",
...
/* $F0 */ "BEQ\0","SBC\0","...\0","...\0","...\0","SBC\0","INC\0","...\0","SED\0","SBC\0","...\0","...\0","...\0","SBC\0","INC\0","...\0"
};
...
void Cpu6502_Disassemble( Cpu6502 *cpu, byte hide_instruction )
{
   ...
   printf( "  %s %-27s", opcode_mnemonic[opcode], Cpu6502_Get_addressing( cpu, string ) );
   
   byte status = cpu->status.carry |
      cpu->status.zero <<1 |
   ...
   printf( " A:%02X X:%02X Y:%02X P:%02X SP:%02X\r\n",
      cpu->a, cpu->x, cpu->y, status, cpu->sp );
}
...
{
   byte opcode = cpu->read_memory_disasm( cpu->sys, cpu->pc );
   byte operand = cpu->read_memory_disasm( cpu->sys, cpu->pc+1 );
   byte operand2 = cpu->read_memory_disasm( cpu->sys, cpu->pc+2 );
